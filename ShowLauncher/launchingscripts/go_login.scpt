...
set one to "ssh bigscreens@192.168.130.240"
set two to "ssh bigscreens@192.168.130.241"
set three to "ssh bigscreens@192.168.130.242"
set server1 to "ssh bigscreens@192.168.130.241"
set server2 to "ssh bigscreens@192.168.130.240"
